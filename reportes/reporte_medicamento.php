...
$pdf->Cell(190,5,"Listado de Medicamentos Disponibles",0,1,'C');
...
$html = "
	<table>
		...
		$sql="SELECT idmedicamento, codigofiltro, nombre, dosificacion, uso, existencia
        FROM medicamento
		WHERE activo = 1
...
foreach($data2 as $student){	
	$html .= "
			<tr>
				<td>". $student->idmedicamento ."</td>
				<td>". $student->codigofiltro ."</td>
				<td>". $student->nombre ."</td>
				<td>". $student->dosificacion ."</td>
				<td>". $student->uso ."</td>
				<td>". $student->existencia ."</td>
			</tr>
			";
}		
