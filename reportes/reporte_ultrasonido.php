...
$pdf->Cell(190,5,"Listado de Ultrasonidos Disponibles",0,1,'C');
...
$html = "
	<table>
		...
		$sql="SELECT idproducto_servicio, nombre, precio from producto_servicio WHERE estado = 1 AND es_ultrasonido = 1 ORDER BY idproducto_servicio DESC";
