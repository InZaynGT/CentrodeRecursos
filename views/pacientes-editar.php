                                    ...
                                    <div class="tab-pane fade in active" id="infoPersonal">
                                        ...
                                        <div class="form-group col-md-11">
                                            <div class="input-group">
                                                ...
                                                <input id="nom_paciente" type="text" name="nom_paciente"
                                                    ...
                                                    value="<?php echo $consulta[0]['nombre']; ?>" ></input>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-5">
                                            <div class="input-group">
                                                ...
                                                <input id="fechadeNacimiento" name="fechadeNacimiento" type="text"
                                                    ...
                                                    value="<?php echo $consulta[0]['fecha']; ?>" >
                                            </div>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <div class="input-group">
                                                ...
                                                <input id="edad" name="edad" type="number"
                                                    class="form-control""
                                                    value="<?php echo $consulta[0]['edad']; ?>" >
                                            </div>
                                        </div>
                                        <div class="form-group col-md-3">
                                                <div class="input-group">
                                            ...
                                            <div class="form-group col-md-8">
                                                <div class="input-group">
                                                    ...
                                                    <textarea id="direccion" name="direccion"
                                                        ...
                                                        style="overflow:auto;resize:none"><?php echo $consulta[0]['direccion']; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-11">
                                                <div class="input-group">
                                                    ...
                                                    <input id="nom_encargado" type="text" name="nom_encargado"
                                                        ...
                                                        value="<?php echo $consulta[0]['nombre_encargado']; ?>"></input>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-11">
                                                <div class="input-group">
                                                    ...
                                                    <input id="telefono_encargado" type="text" name="telefono_encargado"
                                                        class="form-control" maxlength="30" required
                                                        value="<?php echo $consulta[0]['telefono']; ?>" ></input>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-11">
                                                <div class="input-group">
                                                    ...
                                                    <input id="diagnostico" type="text" name="diagnostico"
                                                        class="form-control" maxlength="30" required
                                                        value="<?php echo $consulta[0]['diagnostico']; ?>"></input>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-11">
                                                <div class="input-group">
                                                    ...
                                                    <textarea id="medicamentos_Admin" name="medicamentos_Admin"
                                                        ...
                                                        value="<?php echo $consulta[0]['med_admin']; ?>"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                    ...
                                                    <table class="table table-condensed">
                                                        <tbody>
                                                                ...
                                                                <td>
                                                                    <div>
                                                                        <input id="medico_Tratante" type="text"
                                                                            ...
                                                                            maxlength="150"
                                                                            value="<?php echo $consulta[0]['medico']; ?>"></input>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div>
                                                                        <input id="telefono_medico" type="text"
                                                                            ...
                                                                            maxlength="30"
                                                                            value="<?php echo $consulta[0]['telefono_med']; ?>"></input>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div>
                                                                        <input id="ciclo" type="text" name="ciclo"
                                                                            class="form-control"
                                                                            maxlength="200"
                                                                            value="<?php echo $consulta[0]['examenes_realizados']; ?>"></input>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div>
                                                                        <input class="form-check-input" type="checkbox" id="convulsiona" name="convulsiona" value="1" <?php echo ($consulta[0]['convulsiona'] == 1) ? 'checked' : ''; ?>>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div>
                                                                        <input class="form-check-input" type="checkbox" id="usa_protesis" name="usa_protesis" <?php echo ($consulta[0]['usa_protesis'] == 1) ? 'checked' : ''; ?>>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <td>
                                                                    <div>
                                                                        <input id="cual_protesis" type="text"
                                                                            ...
                                                                            maxlength="200"
                                                                            value="<?php echo $consulta[0]['desc_protesis']; ?>"></input>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div>
                                                                        <input id="observaciones" type="text"
                                                                            ...
                                                                            maxlength="200"
                                                                            value="<?php echo $consulta[0]['observaciones']; ?>"></input>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                            ...
                                            <div class="form-group col-md-11">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="cardiovascular" type=" text" name="cardiovascular"
                                                        ...
                                                        value="<?php echo $consulta[0]['cardiovascular']; ?>"></input>
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                    ...
                                                    <input id="pulmonares" type="text" name="pulmonares"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['pulmonares']; ?>"></input>
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                    ...
                                                    <input id="digestivos" type="text" name="digestivos"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['digestivos']; ?>"></input>
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                    ...
                                                    <input id="diabetes" type="text" name="diabetes"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['diabetes']; ?>"></input>
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                    ...
                                                    <input id="renales" type="text" name="renales"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['renales']; ?>"></input>
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                    ...
                                                    <input id="quirurgicos" type="text" name="quirurgicos"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['quirurgicos']; ?>" ></input>
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                    ...
                                                    <input id="alergicos" type="text" name="alergicos"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['alergicos']; ?>" ></input>
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                    ...
                                                    <input id="transfuciones" type="text" name="transfuciones"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['transfusiones']; ?>" ></input>
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                    ...
                                                    <input id="medicamentos" type="text" name="medicamentos"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['medicamentos']; ?>" ></input>
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                    ...
                                                    <input id="otros_antecedentes" type="text" name="otros_antecedentes"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['otros']; ?>" ></input>
                                                </div>
                                                <br>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="alcohol" type="text" name="alcohol"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['alcohol']; ?>" ></input>
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                    ...
                                                    <input id="tabaquismo" type="text" name="tabaquismo"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['tabaquismo']; ?>" ></input>
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                    ...
                                                    <input id="drogas" type="text" name="drogas"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['drogas']; ?>" ></input>
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                    ...
                                                    <input id="inmunizaciones" type="text" name="inmunizaciones"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['inmunizaciones']; ?>" ></input>
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                    <span class="input-group-addon">Otros:</i></span>
                                                    <input id="otros_inmuniz" type="text" name="otros_inmuniz"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['otros_2']; ?>" ></input>
                                                </div>
                                                <br>
                                                <h5>Padre:</h5>
                                                <div class="input-group">
                                                    ...
                                                    <?php if ($consulta[0]['padre_vive'] == 1) echo 'checked'; ?> >
                                                </div>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="enfermedad_padre" type="text" name="enfermedad_padre"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['padre_enferm']; ?>" ></input>
                                                </div>
                                                <br>
                                                <h5>Madre:</h5>
                                                <div class="input-group">
                                                    ...
                                                    <?php if ($consulta[0]['madre_vive'] == 1) echo 'checked'; ?> >
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                    <span class="input-group-addon">Enfermedades que padece:</i></span>
                                                    <input id="enfermedad_madre" type="text" name="enfermedad_madre"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['madre_enferm']; ?>" ></input>
                                                </div>
                                                <br>
                                                <h5>Hermanos:</h5>
                                                <div class="input-group">
                                                    ...
                                                    <input id="num_hermanos" type="number" name="num_hermanos"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['hermanos']; ?>" ></input>
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                    ...
                                                    <input id="herman_vive" type="number" name="herman_vive"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['cant_hermanos']; ?>" ></input>
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                    ...
                                                    <input id="enfermedad_herm" type="text" name="enfermedad_herm"
                                                        class="form-control" maxlength="30"
                                                        value="<?php echo $consulta[0]['enf_hermanos']; ?>" ></input>
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                    ...
                                                    <input id="observaciones" type="text" name="observaciones"
                                                        ...
                                                        value="<?php echo $consulta[0]['observaciones_ant']; ?>" ></input>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="evaluaciones_fisioterapeuticas">
                                            <div class="form-group col-md-11">
                                                ...
                                                <textarea id="localiza_dolor" name="localiza_dolor"
                                                    ...
                                                    style="overflow:auto;resize:none" ><?php echo $consulta[0]['dolor_donde']; ?></textarea>
                                                <span class="input-group-addon">Irradiación del dolor:</span>
                                                <textarea id="irradia_dolor" name="irradia_dolor"
                                                    class="form-control" maxlength="150" rows="2" text=""
                                                    style="overflow:auto;resize:none" ><?php echo $consulta[0]['dolor_irradiacion']; ?></textarea>
                                                ...
                                                <textarea id="tipo_dolor" name="tipo_dolor" class="form-control"
                                                    ...
                                                    style="overflow:auto;resize:none" ><?php echo $consulta[0]['tipo_dolor']; ?></textarea>
                                        ...
                                        <div class="tab-pane fade" id="tono_muscular">
                                            ...
                                            <div class="container mt-5">
                                                <table class="table" method="POST">
                                                    <tr>
                                                        <td><label class="form-check-label"><input  type="radio" class="form-check-input" name="tono_muscular" value="1" <?php if ($consulta[0]['tipo_tono'] == 1) echo 'checked'; ?>>Espástico</label></td>
                                                        <td><label class="form-check-label"><input  type="radio" class="form-check-input" name="tono_muscular" value="2" <?php if ($consulta[0]['tipo_tono'] == 2) echo 'checked'; ?>>Hipotónico</label></td>
                                                    </tr>
                                                    <tr>
                                                        <td><label class="form-check-label"><input  type="radio" class="form-check-input" name="tono_muscular" value="3" <?php if ($consulta[0]['tipo_tono'] == 3) echo 'checked'; ?>>Atetósico</label></td>
                                                        <td><label class="form-check-label"><input  type="radio" class="form-check-input" name="tono_muscular" value="4" <?php if ($consulta[0]['tipo_tono'] == 4) echo 'checked'; ?>>Fluctuante</label></td>
                                                    </tr>
                                                </table>
                                                <div class="form-inline">
                                                    <label class="mr-2" for="limit_amplit">Presenta limitación en amplitudes articulares:</label>
                                                    <input  class="form-check-input" type="checkbox" id="limit_amplit" name="limit_amplit" <?php if ($consulta[0]['limitacion_artic'] == 1) echo 'checked '; ?>>
                                                </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><input  type="radio" name="control_cuello" value="1" <?php if ($consulta[0]['control_cuello'] == 1) echo 'checked'; ?>></td>
                                                        <td><input  type="radio" name="control_cuello" value="2" <?php if ($consulta[0]['control_cuello'] == 2) echo 'checked'; ?>></td>
                                                        <td><input  type="radio" name="control_cuello" value="3" <?php if ($consulta[0]['control_cuello'] == 3) echo 'checked'; ?>></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Rotación de prono a supino</td>
                                                        <td><input type="radio" name="prono_supino" value=1  <?php if ($consulta[0]['rotacion_prono_supino'] == 1) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="prono_supino" value=2  <?php if ($consulta[0]['rotacion_prono_supino'] == 2) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="prono_supino" value=3  <?php if ($consulta[0]['rotacion_prono_supino'] == 3) echo 'checked'; ?>></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Rotación de supino a prono</td>
                                                        <td><input type="radio" name="supino_prono" value=1  <?php if ($consulta[0]['rotacion_supino_prono'] == 1) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="supino_prono" value=2  <?php if ($consulta[0]['rotacion_supino_prono'] == 2) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="supino_prono" value=3  <?php if ($consulta[0]['rotacion_supino_prono'] == 3) echo 'checked'; ?>></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Control de tronco superior</td>
                                                        <td><input type="radio" name="tronco_superior" value=1  <?php if ($consulta[0]['tronco_superior'] == 1) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="tronco_superior" value=2  <?php if ($consulta[0]['tronco_superior'] == 2) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="tronco_superior" value=3  <?php if ($consulta[0]['tronco_superior'] == 3) echo 'checked'; ?>></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Control de tronco inferior</td>
                                                        <td><input type="radio" name="tronco_inferior" value=1  <?php if ($consulta[0]['tronco_inferior'] == 1) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="tronco_inferior" value=2  <?php if ($consulta[0]['tronco_inferior'] == 2) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="tronco_inferior" value=3  <?php if ($consulta[0]['tronco_inferior'] == 3) echo 'checked'; ?>></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Posición de cuatro puntos</td>
                                                        <td><input type="radio" name="cuatro_puntos" value=1  <?php if ($consulta[0]['cuatro_puntos'] == 1) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="cuatro_puntos" value=2  <?php if ($consulta[0]['cuatro_puntos'] == 2) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="cuatro_puntos" value=3  <?php if ($consulta[0]['cuatro_puntos'] == 3) echo 'checked'; ?>></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Adopta posición sedente</td>
                                                        <td><input type="radio" name="pos_sedente" value=1  <?php if ($consulta[0]['posicion_sedente'] == 1) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="pos_sedente" value=2  <?php if ($consulta[0]['posicion_sedente'] == 2) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="pos_sedente" value=3  <?php if ($consulta[0]['posicion_sedente'] == 3) echo 'checked'; ?>></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Adopta posición hincado</td>
                                                        <td><input type="radio" name="pos_hincado" value=1  <?php if ($consulta[0]['posicion_hincado'] == 1) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="pos_hincado" value=2  <?php if ($consulta[0]['posicion_hincado'] == 2) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="pos_hincado" value=3  <?php if ($consulta[0]['posicion_hincado'] == 3) echo 'checked'; ?>></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Adopta posición semi-hincado</td>
                                                        <td><input type="radio" name="pos_semihincado" value=1  <?php if ($consulta[0]['posicion_semihincado'] == 1) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="pos_semihincado" value=2  <?php if ($consulta[0]['posicion_semihincado'] == 2) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="pos_semihincado" value=3  <?php if ($consulta[0]['posicion_semihincado'] == 3) echo 'checked'; ?>></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Adopta posición de bidepestación</td>
                                                        <td><input type="radio" name="pos_bidepestacion" value=1  <?php if ($consulta[0]['posicion_bidepestacion'] == 1) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="pos_bidepestacion" value=2  <?php if ($consulta[0]['posicion_bidepestacion'] == 2) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="pos_bidepestacion" value=3  <?php if ($consulta[0]['posicion_bidepestacion'] == 3) echo 'checked'; ?>></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        <div class="tab-pane fade" id="atencion">
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td>Localización</td>
                                                    <td><input  type="radio" name="localizacion" value="1" <?php if ($consulta[0]['localizacion'] == 1) echo 'checked'; ?>></td>
                                                    <td><input  type="radio" name="localizacion" value="0" <?php if ($consulta[0]['localizacion'] == 0) echo 'checked'; ?>></td>
                                                </tr>
                                                <tr>
                                                    <td>Fijación</td>
                                                    <td><input  type="radio" name="fijacion" value="1" <?php if ($consulta[0]['fijacion'] == 1) echo 'checked'; ?>></td>
                                                    <td><input  type="radio" name="fijacion" value="0" <?php if ($consulta[0]['fijacion'] == 0) echo 'checked'; ?>></td>
                                                </tr>
                                                <tr>
                                                    <td>Seguimiento</td>
                                                    <td><input  type="radio" name="seguimiento" value="1" <?php if ($consulta[0]['seguimiento'] == 1) echo 'checked'; ?>></td>
                                                    <td><input  type="radio" name="seguimiento" value="0" <?php if ($consulta[0]['seguimiento'] == 0) echo 'checked'; ?>></td>
                                                </tr>
                                                <tr>
                                                    <td>Alcance</td>
                                                    <td><input  type="radio" name="alcance" value="1" <?php if ($consulta[0]['alcance'] == 1) echo 'checked'; ?>></td>
                                                    <td><input  type="radio" name="alcance" value="0" <?php if ($consulta[0]['alcance'] == 0) echo 'checked'; ?>></td>
                                                </tr>
                                                <tr>
                                                    <td>Manipulación</td>
                                                    <td><input  type="radio" name="manipulacion" value="1" <?php if ($consulta[0]['manipulacion'] == 1) echo 'checked'; ?>></td>
                                                    <td><input  type="radio" name="manipulacion" value="0" <?php if ($consulta[0]['manipulacion'] == 0) echo 'checked'; ?>></td>
                                                </tr>
                                                <tr>
                                                    <td>Exploración</td>
                                                    <td><input  type="radio" name="exploracion" value="1" <?php if ($consulta[0]['exploracion'] == 1) echo 'checked'; ?>></td>
                                                    <td><input  type="radio" name="exploracion" value="0" <?php if ($consulta[0]['exploracion'] == 0) echo 'checked'; ?>></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><input type="radio" name="sostiene_objeto" value=1  <?php if ($consulta[0]['sostiene_objeto'] == 1) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="sostiene_objeto" value=0  <?php if ($consulta[0]['sostiene_objeto'] == 0) echo 'checked'; ?>></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Suelta un objeto</td>
                                                        <td><input type="radio" name="suelta_objeto" value=1  <?php if ($consulta[0]['suelta_objeto'] == 1) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="suelta_objeto" value=0  <?php if ($consulta[0]['suelta_objeto'] == 0) echo 'checked'; ?>></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Atrapa un objeto</td>
                                                        <td><input type="radio" name="atrapa_objeto" value=1  <?php if ($consulta[0]['atrapa_objeto'] == 1) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="atrapa_objeto" value=0  <?php if ($consulta[0]['atrapa_objeto'] == 0) echo 'checked'; ?>></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Lanza un objeto</td>
                                                        <td><input type="radio" name="lanza_objeto" value=1  <?php if ($consulta[0]['lanza_objeto'] == 1) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="lanza_objeto" value=0  <?php if ($consulta[0]['lanza_objeto'] == 0) echo 'checked'; ?>></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Realiza un nudo</td>
                                                        <td><input type="radio" name="realiza_nudo" value=1  <?php if ($consulta[0]['realiza_nudo'] == 1) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="realiza_nudo" value=0  <?php if ($consulta[0]['realiza_nudo'] == 0) echo 'checked'; ?>></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Encaja</td>
                                                        <td><input type="radio" name="encaja" value=1  <?php if ($consulta[0]['encaja'] == 1) echo 'checked'; ?>></td>
                                                        <td><input type="radio" name="encaja" value=0  <?php if ($consulta[0]['encaja'] == 0) echo 'checked'; ?>></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        <div class="tab-pane fade" id="actividades_diaria">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td>Alimentación</td>
                                                    <td><input type="radio" name="alimentacion" value="1" <?php if ($consulta[0]['alimentacion'] == 1) echo 'checked'; ?> ></td>
                                                    <td><input type="radio" name="alimentacion" value="2" <?php if ($consulta[0]['alimentacion'] == 2) echo 'checked'; ?> ></td>
                                                    <td><input type="radio" name="alimentacion" value="3" <?php if ($consulta[0]['alimentacion'] == 3) echo 'checked'; ?> ></td>
                                                </tr>
                                                <tr>
                                                    <td>Higiene</td>
                                                    <td><input type="radio" name="higiene" value="1" <?php if ($consulta[0]['higiene'] == 1) echo 'checked'; ?> ></td>
                                                    <td><input type="radio" name="higiene" value="2" <?php if ($consulta[0]['higiene'] == 2) echo 'checked'; ?> ></td>
                                                    <td><input type="radio" name="higiene" value="3" <?php if ($consulta[0]['higiene'] == 3) echo 'checked'; ?> ></td>
                                                </tr>
                                                <tr>
                                                    <td>Vestuario</td>
                                                    <td><input type="radio" name="vestuario" value="1" <?php if ($consulta[0]['vestuario'] == 1) echo 'checked'; ?> ></td>
                                                    <td><input type="radio" name="vestuario" value="2" <?php if ($consulta[0]['vestuario'] == 2) echo 'checked'; ?> ></td>
                                                    <td><input type="radio" name="vestuario" value="3" <?php if ($consulta[0]['vestuario'] == 3) echo 'checked'; ?> ></td>
                                                </tr>
                                                <tr>
                                                    <td>Control de esfínteres</td>
                                                    <td><input type="radio" name="control_esfinteres" value="1" <?php if ($consulta[0]['control_esfinteres'] == 1) echo 'checked'; ?> ></td>
                                                    <td><input type="radio" name="control_esfinteres" value="2" <?php if ($consulta[0]['control_esfinteres'] == 2) echo 'checked'; ?> ></td>
                                                    <td><input type="radio" name="control_esfinteres" value="3" <?php if ($consulta[0]['control_esfinteres'] == 3) echo 'checked'; ?> ></td>
                                                </tr>
                                                <tr>
                                                    <td>Orden y Limpieza</td>
                                                    <td><input type="radio" name="orden_limpieza" value="1" <?php if ($consulta[0]['orden_limpieza'] == 1) echo 'checked'; ?> ></td>
                                                    <td><input type="radio" name="orden_limpieza" value="2" <?php if ($consulta[0]['orden_limpieza'] == 2) echo 'checked'; ?> ></td>
                                                    <td><input type="radio" name="orden_limpieza" value="3" <?php if ($consulta[0]['orden_limpieza'] == 3) echo 'checked'; ?> ></td>
                                                </tr>
                                                <tr>
                                                    <td>Ocio y recreación</td>
                                                    <td><input type="radio" name="ocio_recreacion" value="1" <?php if ($consulta[0]['ocio_recreacion'] == 1) echo 'checked'; ?> ></td>
                                                    <td><input type="radio" name="ocio_recreacion" value="2" <?php if ($consulta[0]['ocio_recreacion'] == 2) echo 'checked'; ?> ></td>
                                                    <td><input type="radio" name="ocio_recreacion" value="3" <?php if ($consulta[0]['ocio_recreacion'] == 3) echo 'checked'; ?> ></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                            <div class="form-group col-md-12">
                                                <div class="input-group col-md-11">
                                                    ...
                                                    <textarea  id="observaciones_actividades" name="observaciones_actividades"
                                            ...
                                            <div class="form-group col-md-11">
                                                <div class="input-group col-md-11">
                                                    <label for="observaciones_postura"
                                                        class="col-form-label">Observaciones:</label>
                                                    <textarea  id="observaciones_postura" name="observaciones_postura"
                                                        class="form-control" rows="2"
                                        ...
                                        <div class="tab-pane fade" id="marcha_desplaza">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><label><input type="radio" name="marcha" value="1" <?php if ($consulta[0]['realiza_marcha'] == 1) echo 'checked'; ?>> Si</label></td>
                                                    <td><label><input type="radio" name="marcha" value="0" <?php if ($consulta[0]['realiza_marcha'] == 0) echo 'checked'; ?>> No</label></td>
                                                </tr>
                                                <tr>
                                                    <td>Base de sustentación</td>
                                                    <td><label><input  type="radio" name="sustentacion" value="1" <?php if ($consulta[0]['base_sustentacion'] == 1) echo 'checked'; ?>> Amplia</label></td>
                                                    <td><label><input  type="radio" name="sustentacion" value="2" <?php if ($consulta[0]['base_sustentacion'] == 2) echo 'checked'; ?>> Disminuida</label></td>
                                                    <td><label><input  type="radio" name="sustentacion" value="3" <?php if ($consulta[0]['base_sustentacion'] == 3) echo 'checked'; ?>> Proporcionada</label></td>
                                                </tr>
                                                <tr>
                                                    <td>Usa silla de ruedas</td>
                                                    <td><label><input  type="radio" name="silla_ruedas" value="1" <?php if ($consulta[0]['silla_ruedas'] == 1) echo 'checked'; ?>> Si</label></td>
                                                    <td><label><input  type="radio" name="silla_ruedas" value="0" <?php if ($consulta[0]['silla_ruedas'] == 0) echo 'checked'; ?>> No</label></td>
                                                </tr>
                                                <tr>
                                                    <td>Realiza con apoyo</td>
                                                    <td><label><input  type="radio" name="apoyo" value="1" <?php if ($consulta[0]['realiza_apoyo'] == 1) echo 'checked'; ?>> Si</label></td>
                                                    <td><label><input  type="radio" name="apoyo" value="0" <?php if ($consulta[0]['realiza_apoyo'] == 0) echo 'checked'; ?>> No</label></td>
                                                </tr>
                                                <tr>
                                                    <td>Equilibrio</td>
                                                    <td><label><input  type="radio" name="equilibrio" value="1" <?php if ($consulta[0]['equilibrio'] == 1) echo 'checked'; ?>> Bueno</label></td>
                                                    <td><label><input  type="radio" name="equilibrio" value="2" <?php if ($consulta[0]['equilibrio'] == 2) echo 'checked'; ?>> Regular</label></td>
                                                    <td><label><input  type="radio" name="equilibrio" value="3" <?php if ($consulta[0]['equilibrio'] == 3) echo 'checked'; ?>> Malo</label></td>
                                                </tr>
                                                <tr>
                                                    <td>Coordinación</td>
                                                    <td><label><input  type="radio" name="coordinacion" value="1" <?php if ($consulta[0]['coordinacion'] == 1) echo 'checked'; ?>> Bueno</label></td>
                                                    <td><label><input  type="radio" name="coordinacion" value="2" <?php if ($consulta[0]['coordinacion'] == 2) echo 'checked'; ?>> Regular</label></td>
                                                    <td><label><input  type="radio" name="coordinacion" value="3" <?php if ($consulta[0]['coordinacion'] == 3) echo 'checked'; ?>> Malo</label></td>
                                                </tr>
                                                <tr>
                                                    <td>Utiliza dispositivo:</td>
                                                    <td><label><input  type="radio" name="dispositivo" value="1" <?php if ($consulta[0]['utiliza_dispositivo'] == 1) echo 'checked'; ?>> Si</label></td>
                                                    <td><label><input  type="radio" name="dispositivo" value="0" <?php if ($consulta[0]['utiliza_dispositivo'] == 0) echo 'checked'; ?>> No</label></td>
                                                </tr>
                                            ...
                                            <div class="input-group col-md-11">
                                                ...
                                                <textarea  id="cual_dispositivo" name="cual_dispositivo"
                                                    class="form-control" rows="2"
