							...
							$(document).ready(function () {
								...
								$("#tablaConsultas").dataTable({
									...
									"fnCreatedRow": function (nRow, aData, iDataIndex) {
										...
										$('td:eq(5)', nRow).append('<a title="Editar Consulta" href="<?php echo BASE_DIR; ?>editar-consulta/' + aData[0] + '-' + aData[1] + '"><i class="fa fa-edit" style="font-size:30px; margin-right:3px"></i></a>').css('text-align', 'center')
						...
						<table id="tablaConsultas" class="table table-bordered table-striped">
							<thead>
								<tr>
									...
									<th>Código Interno de Paciente</th>
