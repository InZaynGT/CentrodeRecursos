                                ...
                                <div id="my-tab-content" class="tab-content">
                                    <div class="tab-pane fade in active" id="infoPersonal">
                                        ...
                                        <div class="form-group col-md-11">
                                            <div class="input-group">
                                                ...
                                                <input id="nom_paciente" type="text" name="nom_paciente"
                                                    class="form-control" maxlength="100" required></input>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class=" form-group col-md-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon">Sexo:</i></span>
                                            ...
                                            <div class="form-group col-md-3">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i
                                                            class="fa fa-mars-stroke-v"></i></span>
                                                                ...
                                                                <td>
                                                                    <div>
                                                                        <input class="form-check-input" type="checkbox"
                                                                            id="convulsiona" name="convulsiona" value="1">
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div>
                                                                        <input class="form-check-input" type="checkbox"
                                                                            id="usa_protesis" name="usa_protesis">
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                        ...
                                        <div class="tab-pane fade" id="antecedentes">
                                            <div class="form-group col-md-11">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" id="padre_vivo"
                                                        name="padre_vivo" value="1">
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon">Vivo:</i></span>
                                                    <input class="form-check-input" type="checkbox" id="madre_vivo"
                                                        name="madre_vivo" value="1">
                                                </div>
                                                <br>
                                                <div class="input-group">
                                                    <span class="input-group-addon">Enfermedades que padece:</i></span>
                                        ...
                                        <div class="tab-pane fade" id="tono_muscular">
                                            ...
                                            <div class="container mt-5">
                                                <table class="table" method="POST">
                                                    <tr>
                                                        <td><label class="form-check-label"><input type="radio"
                                                                    class="form-check-input" name="tono_muscular"
                                                                    value="1">Espástico</label></td>
                                                        <td><label class="form-check-label"><input type="radio"
                                                                    class="form-check-input" name="tono_muscular"
                                                                    value="2">Hipotónico</label></td>
                                                    </tr>
                                                    <tr>
                                                        <td><label class="form-check-label"><input type="radio"
                                                                    class="form-check-input" name="tono_muscular"
                                                                    value="3">Atetósico</label></td>
                                                        <td><label class="form-check-label"><input type="radio"
                                                                    class="form-check-input" name="tono_muscular"
                                                                    value="4">Fluctuante</label></td>
                                                    </tr>
                                                </table>
                                                <div class="form-inline">
                                                    <label class="mr-2" for="padre_vivo">Presenta limitación en
                                                        amplitudes articulares:</label>
                                                    <input class="form-check-input" type="checkbox" id="limit_amplit"
                                                        name="limit_amplit">
                                                </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><input type="radio" name="control_cuello" value=1></td>
                                                        <td><input type="radio" name="control_cuello" value=2></td>
                                                        <td><input type="radio" name="control_cuello" value=3></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Rotación de prono a supino</td>
                                                        <td><input type="radio" name="prono_supino" value=1></td>
                                                        <td><input type="radio" name="prono_supino" value=2></td>
                                                        <td><input type="radio" name="prono_supino" value=3></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Rotación de supino a prono</td>
                                                        <td><input type="radio" name="supino_prono" value=1></td>
                                                        <td><input type="radio" name="supino_prono" value=2></td>
                                                        <td><input type="radio" name="supino_prono" value=3></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Control de tronco superior</td>
                                                        <td><input type="radio" name="tronco_superior" value=1></td>
                                                        <td><input type="radio" name="tronco_superior" value=2></td>
                                                        <td><input type="radio" name="tronco_superior" value=3></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Control de tronco inferior</td>
                                                        <td><input type="radio" name="tronco_inferior" value=1></td>
                                                        <td><input type="radio" name="tronco_inferior" value=2></td>
                                                        <td><input type="radio" name="tronco_inferior" value=3></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Posición de cuatro puntos</td>
                                                        <td><input type="radio" name="cuatro_puntos" value=1></td>
                                                        <td><input type="radio" name="cuatro_puntos" value=2></td>
                                                        <td><input type="radio" name="cuatro_puntos" value=3></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Adopta posición sedente</td>
                                                        <td><input type="radio" name="pos_sedente" value=1></td>
                                                        <td><input type="radio" name="pos_sedente" value=2></td>
                                                        <td><input type="radio" name="pos_sedente" value=3></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Adopta posición hincado</td>
                                                        <td><input type="radio" name="pos_hincado" value=1></td>
                                                        <td><input type="radio" name="pos_hincado" value=2></td>
                                                        <td><input type="radio" name="pos_hincado" value=3></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Adopta posición semi-hincado</td>
                                                        <td><input type="radio" name="pos_semihincado" value=1></td>
                                                        <td><input type="radio" name="pos_semihincado" value=2></td>
                                                        <td><input type="radio" name="pos_semihincado" value=3></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Adopta posición de bidepestación</td>
                                                        <td><input type="radio" name="pos_bidepestacion" value=1></td>
                                                        <td><input type="radio" name="pos_bidepestacion" value=2></td>
                                                        <td><input type="radio" name="pos_bidepestacion" value=3></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        <div class="tab-pane fade" id="atencion">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>Localización</td>
                                                        <td><input type="radio" name="localizacion" value=1></td>
                                                        <td><input type="radio" name="localizacion" value=0></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Fijación</td>
                                                        <td><input type="radio" name="fijacion" value=1></td>
                                                        <td><input type="radio" name="fijacion" value=0></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Seguimiento</td>
                                                        <td><input type="radio" name="seguimiento" value=1></td>
                                                        <td><input type="radio" name="seguimiento" value=0></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Alcance</td>
                                                        <td><input type="radio" name="alcance" value=1></td>
                                                        <td><input type="radio" name="alcance" value=0></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Manipulación</td>
                                                        <td><input type="radio" name="manipulacion" value=1></td>
                                                        <td><input type="radio" name="manipulacion" value=0></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Exploración</td>
                                                        <td><input type="radio" name="exploracion" value=1></td>
                                                        <td><input type="radio" name="exploracion" value=0></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><input type="radio" name="sostiene_objeto" value=1></td>
                                                        <td><input type="radio" name="sostiene_objeto" value=0></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Suelta un objeto</td>
                                                        <td><input type="radio" name="suelta_objeto" value=1></td>
                                                        <td><input type="radio" name="suelta_objeto" value=0></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Atrapa un objeto</td>
                                                        <td><input type="radio" name="atrapa_objeto" value=1></td>
                                                        <td><input type="radio" name="atrapa_objeto" value=0></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Lanza un objeto</td>
                                                        <td><input type="radio" name="lanza_objeto" value=1></td>
                                                        <td><input type="radio" name="lanza_objeto" value=0></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Realiza un nudo</td>
                                                        <td><input type="radio" name="realiza_nudo" value=1></td>
                                                        <td><input type="radio" name="realiza_nudo" value=0></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Encaja</td>
                                                        <td><input type="radio" name="encaja" value=1></td>
                                                        <td><input type="radio" name="encaja" value=0></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                        <div class="tab-pane fade" id="actividades_diaria">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>Alimentación</td>
                                                        <td><input type="radio" name="alimentacion" value=1></td>
                                                        <td><input type="radio" name="alimentacion" value=2></td>
                                                        <td><input type="radio" name="alimentacion" value=3></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Higiene</td>
                                                        <td><input type="radio" name="higiene" value=1></td>
                                                        <td><input type="radio" name="higiene" value=2></td>
                                                        <td><input type="radio" name="higiene" value=3></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Vestuario</td>
                                                        <td><input type="radio" name="vestuario" value=1></td>
                                                        <td><input type="radio" name="vestuario" value=2></td>
                                                        <td><input type="radio" name="vestuario" value=3></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Control de esfínteres</td>
                                                        <td><input type="radio" name="control_esfinteres" value=1></td>
                                                        <td><input type="radio" name="control_esfinteres" value=2></td>
                                                        <td><input type="radio" name="control_esfinteres" value=3></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Orden y Limpieza</td>
                                                        <td><input type="radio" name="orden_limpieza" value=1></td>
                                                        <td><input type="radio" name="orden_limpieza" value=2></td>
                                                        <td><input type="radio" name="orden_limpieza" value=3></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Ocio y recreación</td>
                                                        <td><input type="radio" name="ocio_recreacion" value=1></td>
                                                        <td><input type="radio" name="ocio_recreacion" value=2></td>
                                                        <td><input type="radio" name="ocio_recreacion" value=3></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><label><input type="radio" name="marcha" value=1> Si</label></td>
                                                        <td><label><input type="radio" name="marcha" value=0> No</label></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Base de sustentación</td>
                                                        <td><label><input type="radio" name="sustentacion" value=1> Amplia</label></td>
                                                        <td><label><input type="radio" name="sustentacion" value=2> Disminuida</label></td>
                                                        <td><label><input type="radio" name="sustentacion" value=3> Proporcionada</label></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Usa silla de ruedas</td>
                                                        <td><label><input type="radio" name="silla_ruedas" value=1> Si</label></td>
                                                        <td><label><input type="radio" name="silla_ruedas" value=0> No</label></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Realiza con apoyo</td>
                                                        <td><label><input type="radio" name="apoyo" value=1> Si</label></td>
                                                        <td><label><input type="radio" name="apoyo" value=0> No</label></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Equilibrio</td>
                                                        <td><label><input type="radio" name="equilibrio" value=1> Bueno</label></td>
                                                        <td><label><input type="radio" name="equilibrio" value=2> Regular</label></td>
                                                        <td><label><input type="radio" name="equilibrio" value=3> Malo</label></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Coordinación</td>
                                                        <td><label><input type="radio" name="coordinacion" value=1> Bueno</label></td>
                                                        <td><label><input type="radio" name="coordinacion" value=2> Regular</label></td>
                                                        <td><label><input type="radio" name="coordinacion" value=3> Malo</label></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Utiliza dispositivo:</td>
                                                        <td><label><input type="radio" name="dispositivo" value=1> Si</label></td>
                                                        <td><label><input type="radio" name="dispositivo" value=0> No</label></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            <div class="input-group col-md-11">
