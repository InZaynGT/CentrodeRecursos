		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					...
					<div>
						<a class="btn-danger pull-right d-flex" style="margin:1rem; padding:1rem; border-radius:3px" href="reportes/reporte_servicio.php" target="_blank" style="text-decoration:none;">PDF</a>
					</div>
						...
						<script>
							$(document).ready(function() {
								$("#tablaServicios").dataTable({
									...
									// "paging": true,
									// "processing": true,
									//"ajax": "<?php echo BASE_DIR; ?>serverside/getDataServicios.php",
									"pageLength": 50,
									"fnCreatedRow": function(nRow, aData, iDataIndex) {

										$('td:eq(3)', nRow).append('<a title="Editar" href="<?php echo BASE_DIR; ?>editar-servicio/' + aData[0] + '-' + aData[0] + '"><i class="fa fa-edit" style="font-size:16px; margin-right:3px"></i></a>').css('text-align', 'center')
										$('td:eq(3)', nRow).append('<a title="Eliminar" href="<?php echo BASE_DIR; ?>eliminarServicio/' + aData[0] + '-' + aData[0] + '"><i class="fa fa-close" style="color:red; font-size:16px"></i></a>').css('text-align', 'center')
									},
